  ...
  return (
    <div>
      ...
      <main>
        ...
        <section>
          <img src="assets/img/banner-sabores.jpg" alt="sorvetes diversos" />
          <h2>Novos e deliciosos!</h2>
          <p>
        ...
        <section>
          ...
          <img src="assets/img/eventos-image.jpg" alt="mesa de festa"/>
        </section>

        <section>
          <img src="assets/img/sobre-image.jpg" alt="pessoas comendo sorvete"/>
          <div>
            <h2>SOBRE NÓS</h2>
